...
export function Portfolio() {
  return (
    ...
    <div className="max-w-[800px]  w-full  mx-auto text-center flex flex-col justify-center pt-10">
            ...
            >
      Upload your Portfolio in excel format for analysis            </p>
          
        
    
      <label htmlFor="fileInput" className="block mx-auto mt-4 px-8 py-4 w-72 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition duration-300">
        <span className="text-2xl font-bold">+</span> Add Portfolio File
      </label>
      <input type="file" id="fileInput" accept=".xls, .xlsx" onChange={handleFile} className="hidden" />
    </div>
